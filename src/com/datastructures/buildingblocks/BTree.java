...
public class BTree<Key extends Comparable<Key>, Value>  {
  ...
  private String toString(Node h, int ht, String indent) {
      ...
      System.out.println("Children of the current node are ");
      ...
      System.out.println();
      System.out.println("End of children of this node");
      for(Entry e:children) {
        System.out.println("\n--->");
        if(e!=null) {
          Node temp = e.next;
          if(temp != null) {
          Entry[] nextChildren = temp.children;
          for(Entry en:nextChildren) {
            if(en!=null) {
  ...
  *************************************************************************/
  public static void main(String[] args) {
      ...
      st.put("www.csprinceton.edu", "128.112.136.11");
      ...
      st.put("www.abc.com",          "64.236.16.20");
      st.put("www.def.com",       "216.239.41.99");
      st.put("www.ghi.com",      "199.239.136.200");
      st.put("www.jklm.com",    "207.126.99.140");
